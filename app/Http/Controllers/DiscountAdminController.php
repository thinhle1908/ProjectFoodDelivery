...
class DiscountAdminController extends Controller
{
    ...
    public function postCreateDiscount(Request $request)
    {
        ...
        return redirect(route('discount.admin'))->withSuccess('Create Successfuly');
    }
    ...
    public function getEditDiscount($id)
    {
        ...
        return view('editDiscount')->with('discount', $discount);
    }
    ...
    public function postEditDiscount(Request $request,$id)
    {
        ...
        return redirect(route('discount.admin'))->withSuccess('Edit Successfuly');
    }
    ...
    public function deleteDiscount($id)
    {
        ...
        return redirect(route('discount.admin'))->withSuccess('Delete Successfuly');
    }
}
